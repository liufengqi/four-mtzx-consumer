...
<div class="posi_parent">
    ...
    <article class="whiteBg trad_list" style="padding:10px 30px 60px">
        ...
        <form id="zhaofang" method="post">
        <section class="entrust_sale">
            <ul class="assess_cont">
                <li><span>联<em style="padding:2px 4px;"></em>系<em style="padding:2px 4px;"></em>人</span>：<input id="garden" name="lianxiren" class="text detelValue" type="text" placeholder="请输入你的姓名"  maxlength="15" /></li>
                <li><span>委托类型</span>：&nbsp;&nbsp;<label><input type="radio" name="weituotype" value="1"><font size="4">求租</font></label>&nbsp;&nbsp;&nbsp;<label><input type="radio" name="weituotype" value="2"><font size="4">求购</font></label></li>
                <li><span>希望区域</span>：<input  name="xiwangquyu" class="text detelValue" type="text" placeholder="请输入在什么区域"  maxlength="15" /></li>
                <li><span>需<em style="padding:10px 18px;"></em>求</span>：<input  name="xuqiu" class="text detelValue" type="text" placeholder="请输入要什么要求"  maxlength="15" /></li>
                <li><span>手<em style="padding:2px 4px;"></em>机<em style="padding:2px 4px;"></em>号</span>：<input name="phone" class="text detelValue" type="text" placeholder="请输入你的需求"  maxlength="15" /></li>

      <%--          <li><span>面<em style="padding:10px 18px;"></em>积</span>：<input id="area" class="text detelValue" type="text" v="您的房子的面积(㎡)" value="您的房子的面积(㎡)" maxlength="11"/></li>
                <li><span>期望售价</span>：<input id="price" class="text detelValue" type="text" v="请输入您的期望售价(万元)" value="请输入您的期望售价(万元)" maxlength="11" /></li>
                <li><span>联系方式</span>：<input id="Phone" class="text detelValue" type="text" v="请输入您的手机号码" value="请输入您的手机号码" /></li>
                <li style="position: relative; display: none;" id="liYZM" >
                    <span>验<em style="padding:10px 5px;"></em>证<em style="padding:10px 5px;"></em>码</span>：<input id="yzm" class="text detelValue" type="text" v="请输入短信验证码" value="请输入短信验证码" />
                    <a id="btnSendCode_sell" class="mai-ico" href="javascript:">发送验证码</a>
                </li>--%>
            </ul>
            <button class="assess_btn" id="btnSubmit" onclick="sum()">提&nbsp;&nbsp;&nbsp;&nbsp;交</button>
...
<script type='text/javascript'>
    ...
    function sum(){
        $.ajax({
            url:"<%=request.getContextPath()%>/zxhtwo/insertZhaoFang",
            type:"post",
            data:$("#zhaofang").serialize(),
            dataType:"text",
