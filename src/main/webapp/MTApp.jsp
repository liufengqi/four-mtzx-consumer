    ...
    <div class='header'>
        ...
        <div class="nav_wrap clearfix">
            ...
            <ul class="nav_list float_l">
                <li><a onclick="ga('send', 'event', 'quanzhanyetou', 'zhudaohang', 'shouye');" href='<%=request.getContextPath()%>/mtzx.jsp' >首页</a></li>
                <li>
                ...
                <li>
                    <a onclick=" ga('send', 'event', 'quanzhanyetou', 'zhudaohang', 'jingjiren');" href='
                            <%=request.getContextPath()%>/zxh/fangchanguwen.jsp'>委托卖房
                    </a>
                </li>
                <!--<li>
